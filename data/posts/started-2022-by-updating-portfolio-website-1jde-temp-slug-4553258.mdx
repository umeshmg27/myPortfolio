...
- [Projects Page](https://mUmesh .me/projects)
In previous version, I had projects list on home page. Now I added separate page for projects. [Code](https://github.com/MA-Umesh /myPortfolio/blob/main/pages/projects.tsx)

- [Popular Articles](https://mUmesh .me)
Removed projects list from home page and added popular articles. [Code](https://github.com/MA-Umesh /myPortfolio/blob/main/components/home-page/PopularArticles.tsx)

- [Linked with Prisma ORM](https://www.prisma.io/)

- [Post Like Feature](https://mUmesh .me/blog)
Now user can like posts and posts likes will be updated in real time wrt dev.to posts likes. [Code](https://github.com/MA-Umesh /myPortfolio/blob/main/components/ui/LikeButton.tsx)

- [Dotted squares](https://mUmesh .me)
Updated layout by adding dotted squares on both sides of page(from left to right). [Code](https://github.com/MA-Umesh /myPortfolio/blob/main/components/layout/appLayout.tsx)
...
#### Website link: [ma-Umesh ](https://mUmesh .me)
