export const repositories = [
  {
    ...
    url: 'https://github.com/MA-Umesh /myPortfolio',
    live: 'https://mUmesh .me',
  ...
  //   url: 'https://github.com/MA-Umesh /portfolio',
  //   live: 'https://ma-Umesh .github.io/portfolio',
  //   blurHash: 'L25#he^nryxc^-w$V{V_56bqx[M{',
  //   stars: '92',
  //   fork: '13'
  // },
  ...
  //   url: 'https://github.com/MA-Umesh /templatesKart',
  ...
  //   url: 'https://github.com/MA-Umesh /dev.to-clone',
  ...
  //   technologies: ['react', 'chakraUi'],
  //   url: 'https://github.com/MA-Umesh /portfolio2',
  //   live: 'https://ma-Umesh .github.io/portfolio2',
  ...
  //   url: 'https://github.com/MA-Umesh /notebook',
  //   live: 'https://ma-Umesh .github.io/notebook',
  ...
  //   url: 'https://github.com/MA-Umesh /reactBlog',
  //   live: 'https://ma-Umesh .github.io/reactBlog',
  //   blurHash: 'LMMaw^IV~pxu00%LRjNGAIIVadt6',
  //   stars: '18',
  //   fork: '2'
  // },
  ...
  //   url: 'https://github.com/MA-Umesh /blog-app-react-frontend',
  ...
  //   technologies: ['react', 'typescript', 'chakraUI'],
  //   url: 'https://github.com/MA-Umesh /card-portfolio',
  //   live: 'https://ma-Umesh .github.io/card-portfolio',
  ...
  //   url: 'https://github.com/MA-Umesh /quickstart-rails-tailwind',
  ...
  //   technologies: ['rails', 'tailwindCss'],
  //   url: 'https://github.com/MA-Umesh /react_rails_blog',
  ...
  //   url: 'https://github.com/MA-Umesh /react-image-gallery',
  //   blurHash: 'LMOWg4wIS$WBH?sAkCR*?^bcnNoy',
  //   stars: '5'
  // }
  ...
  //   cover: "",
  //   technologies: ["ruby"],
  //   url: "https://github.com/MA-Umesh /Video-to-text",
  //   blurHash: "L4S~x5xb~q$*~WR6MykCx^Vt4TtP",
  //   stars: "1"
  // }
  // {
  ...
  //   url: "https://github.com/MA-Umesh /rails-authentication-app",
  //   blurHash: "L4S~x5xb~q$*~WR6MykCx^Vt4TtP",
  //   stars: "1"
  // },
  // {
  ...
  //   technologies: ["ruby", "rails"],
  //   url: "https://github.com/MA-Umesh /blog-app-rails-backend",
  //   blurHash: "L4S~x5xb~q$*~WR6MykCx^Vt4TtP",
  //   stars: "2"
  // }
];
